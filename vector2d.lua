...
function Vector2D.__mul(left_operand, right_operand)
  ...
  assertions.is_true(
    (is_left_operand_vector_2d and is_right_operand_vector_2d)
    or (is_left_operand_vector_2d and is_right_operand_number)
    or (is_left_operand_number and is_right_operand_vector_2d)
  )

  if is_left_operand_number then
    return right_operand:mul(left_operand)
  end

  if is_right_operand_number then
    return left_operand:mul(right_operand)
  end

  if is_left_operand_vector_2d and is_right_operand_vector_2d then
    return left_operand:mul(right_operand)
  end
end
