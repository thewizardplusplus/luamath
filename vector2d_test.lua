...
function TestVector2D.test_mul_method_component_wise()
  local vector = Vector2D:new(2, 3)
...
function TestVector2D.test_mul_metamethod_component_wise()
  local vector = Vector2D:new(2, 3)
  local other_vector = Vector2D:new(4, 5)
...
function TestVector2D.test_div_method_component_wise()
...
function TestVector2D.test_div_metamethod_component_wise()
  local vector = Vector2D:new(8, 27)
  local other_vector = Vector2D:new(2, 3)
...
function TestVector2D.test_div_by_zero_component_wize_x()
  local vector = Vector2D:new(1, 1)
