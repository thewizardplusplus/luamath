...
function Matrix3x3.__mul(left_operand, right_operand)
  ...
  assertions.is_true(
    ...
    or (is_left_operand_matrix_3x3 and is_right_operand_vector_2d)
    or (is_left_operand_matrix_3x3 and is_right_operand_number)
    or (is_left_operand_vector_2d and is_right_operand_matrix_3x3)
    or (is_left_operand_number and is_right_operand_matrix_3x3)
  )

  if is_left_operand_number or is_left_operand_vector_2d then
    return right_operand:mul(left_operand)
  end

  if is_right_operand_number or is_right_operand_vector_2d then
    return left_operand:mul(right_operand)
  end

  if is_left_operand_matrix_3x3 and is_right_operand_matrix_3x3 then
    return left_operand:mul(right_operand)
  end
end
...
function Matrix3x3.__div(left_operand, right_operand)
  assertions.is_instance(left_operand, Matrix3x3)
  assertions.is_number(right_operand, Matrix3x3)
